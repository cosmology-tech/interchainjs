...
export class MsgClientImpl implements Msg {
  ...
  grantAllowance(signerAddress: string, message: MsgGrantAllowance, fee: number | StdFee | "auto" = "auto", memo: string = ""): Promise<DeliverTxResponse> {
    const data = [{
  ...
  revokeAllowance(signerAddress: string, message: MsgRevokeAllowance, fee: number | StdFee | "auto" = "auto", memo: string = ""): Promise<DeliverTxResponse> {
    const data = [{
