...
import { VoteOption, WeightedVoteOption, WeightedVoteOptionAmino, Params, ParamsAmino, voteOptionFromJSON, voteOptionToJSON } from "./gov";
...
export const MsgVote = {
  ...
  is(o: any): o is MsgVote {
    return o && (o.$typeUrl === MsgVote.typeUrl || typeof o.proposalId === "bigint" && typeof o.voter === "string" && o.option && typeof o.metadata === "string");
  },
  isAmino(o: any): o is MsgVoteAmino {
    return o && (o.$typeUrl === MsgVote.typeUrl || typeof o.proposal_id === "bigint" && typeof o.voter === "string" && o.option && typeof o.metadata === "string");
  },
