...
export interface ReactiveQueryValidatorDistributionInfoRequest {
...
export interface ReactiveQueryValidatorDistributionInfoResponse {
  operatorAddress: ComputedRef<string>;
  selfBondRewards: ComputedRef<DecCoin[]>;
