...
export const createRPCQueryClient = async ({
  ...
  return {
    cosmos: {
      ...
      base: {
        grpc: {
          v2: (await import("./base/grpc/v2/service.rpc.Service")).createRpcQueryExtension(client)
        },
        node: {
          v1beta1: (await import("./base/node/v1beta1/query.rpc.Service")).createRpcQueryExtension(client),
          v2: (await import("./base/node/v2/query.rpc.Service")).createRpcQueryExtension(client)
        },
        tendermint: {
