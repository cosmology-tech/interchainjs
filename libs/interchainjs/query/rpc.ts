...
import { CometBroadcastResponse, Status } from "@interchainjs/cosmos/types/rpc";
import {
  broadcast,
  createTxRpc,
  getPrefix,
} from "@interchainjs/cosmos/utils/rpc";
...
import { constructAuthInfo } from "../utils";
...
export class RpcClient implements QueryClient<TxBody, SignerInfo, BaseAccount> {
