...
describe("Token transfers", () => {
  ...
  it("send osmosis token to address", async () => {
    ...
    const address2 = defaultSignerConfig.publicKey
      .hash(auth2.getPublicKey(defaultSignerConfig.publicKey.isCompressed))
  ...
  it("send ibc osmo tokens to address on cosmos chain", async () => {
    ...
    const cosmosAddress = defaultSignerConfig.publicKey
      .hash(cosmosAuth.getPublicKey(defaultSignerConfig.publicKey.isCompressed))
