...
> _stargate_ messages types can be found in [cosmos/stargate/src/stargate.ts](https://github.com/cosmology-tech/sign/blob/main/cosmos/stargate/src/stargate.ts)

> _cosmwasm_ messages types can be found in [cosmos/cosmwasm-stargate/src/cosmwasm.ts](https://github.com/cosmology-tech/sign/blob/main/cosmos/cosmwasm-stargate/src/cosmwasm.ts)
